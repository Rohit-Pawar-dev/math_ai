    ...
    <section className="formSection">
      <div className="card">
        <div className="card-header d-flex justify-content-between">
          <h5>Cheat Sheet</h5>
          <button type="button" className="btn btn-primary btn-sm" onClick={() => navigate('/admin/cheat-sheet/create')}>Add</button>
        </div>
            ...
            <tbody>
              {
                ...
                calculatorList.map((elm,ind) => {
                  return <tr key={ind+1}>
                    ...
                    <td>{elm.type}</td>
                    <td>
                      <button type="button" className="btn btn-primary btn-sm m-2 editbtn" onClick={() => navigate('/admin/cheat-sheet/edit/' + elm._id)}><i className="fa fa-pencil"></i></button>
