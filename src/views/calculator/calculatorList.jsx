    ...
    <section className="formSection">
      <div className="card">
        <div className="card-header d-flex justify-content-between">
          <h5>Calculator</h5>
          <button type="button" className="btn btn-primary btn-sm" onClick={() => navigate('/calculator/create')}>Add</button>
        </div>
            ...
            <tbody>
              {
                ...
                calculatorList.map((elm,ind) => {
                  return <tr key={ind+1}>
                    ...
                    <td>
                      <button type="button" className="btn btn-primary btn-sm m-2 editbtn" onClick={() => navigate('/calculator/edit/' + elm._id)}><i className="fa fa-pencil"></i></button>
