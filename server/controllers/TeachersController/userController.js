...
exports.createUser = async (req, res) => {
  try {
    const { name, email, mobile, password, status, classStandard, teacher_id } = req.body
    ...
    const user = await User.create({
      ...
      status,
      classStandard,
      teacher_id, // link user to teacher
...
exports.getUsers = async (req, res) => {
  try {
    ...
    const query = {
      role: 'user',
      ...(teacherId ? { teacher_id: teacherId } : {}), // filter by teacher_id if provided
      $or: [
...
exports.updateUser = async (req, res) => {
  try {
    ...
    const { name, email, mobile, status, password, classStandard, teacher_id } = req.body
