...
router.get("/teacher/questions/:id", questionController.getQuestionById);

//-----------------------Quiz Routes -----------------
router.post("/teacher/quizzes",auth, quizController.createQuiz);
router.get("/teacher/quizzes/:id", quizController.getQuizById);
router.put("/teacher/quizzes/:id", quizController.updateQuiz);
router.delete("/teacher/quizzes/:id", quizController.deleteQuiz);
router.put("/teacher/quizzes/:id/add-questions", quizController.addQuestionsToQuiz);
router.put("/teacher/quizzes/:id/set-questions", quizController.setQuestionsForQuiz);
router.get("/teacher/quizzes", auth, quizController.getQuizzesByTeacher);
